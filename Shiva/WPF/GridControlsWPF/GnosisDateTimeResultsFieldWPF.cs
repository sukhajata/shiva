...
{
    public class GnosisDateTimeResultsFieldWPF : GnosisGridDateTimeFieldWPF, IGnosisDateTimeResultsFieldImplementation
    {
        ...
        public void SetMouseUpHandler(Action action)
        {
            ...
            this.MouseUp += GnosisDateTimeResultsFieldWPF_MouseUp;
        }

        private void GnosisDateTimeResultsFieldWPF_MouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
        ...
        public void SetGotMouseFocusHandler(Action action)
        {
            ...
            this.MouseEnter += GnosisDateTimeResultsFieldWPF_MouseEnter;
        }

        private void GnosisDateTimeResultsFieldWPF_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
        ...
        public void SetLostMouseFocusHandler(Action action)
        {
            ...
            this.MouseLeave += GnosisDateTimeResultsFieldWPF_MouseLeave;

        }

        private void GnosisDateTimeResultsFieldWPF_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
